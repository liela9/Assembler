...
static ptr_label head_label;/*Head node of the list "label"*/
static ptr_label tail_label;/*Tail node of the list "label"*/
static ptr_label_apearence label_apear_head;/*Head node of the list "label_apearence"*/
